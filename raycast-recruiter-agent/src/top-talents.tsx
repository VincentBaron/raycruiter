...
const DUMMY_TALENTS = [
  {
    ...
    signal: "Just finished Series A startup",
    available: true,
  ...
  },
  {
    ...
    signal: "Open to Work badge added",
    available: true,
    keywords: ["Leadership", "AWS", "Python"],
  },
  {
    id: "3",
    name: "Carol Stack",
    role: "Fullstack Developer",
    signal: "Company laid off 10%",
    available: true,
    keywords: ["Vue", "Go", "PostgreSQL"],
  },
];
            ...
            actions={
              <ActionPanel>
                <Action.Push
                  ...
                  target={<SourceCompanies talent={t} />}
                />
              </ActionPanel>
            }
          />
