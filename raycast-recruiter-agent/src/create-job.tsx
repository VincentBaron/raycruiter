...
const jobPayload = JSON.parse(
  fs.readFileSync(
    "/Users/vincentbaron/raycruiter/raycast-recruiter-agent/dummy_job_payload_creation.json",
    "utf8",
  ),
);
...
export default function CreateJobFromDeal(props: { defaultDealName?: string }) {
  ...
  async function handleSubmit() {
    await showToast({
      ...
      title: "Creating ATS Job Posting...",
    });
  ...
  return (
    <Form
      ...
      actions={
        <ActionPanel>
          <Action.SubmitForm
            title="Create Job & Configure Multi-Diffusion"
            icon={Icon.Upload}
