...
const HUB_COMMANDS = [
  {
    ...
    subtitle: "Manage active CRM deals",
    icon: Icon.Box,
    component: <CrmView />,
  },
  {
    ...
    icon: Icon.List,
    component: <JobsCommand />,
  },
  {
    id: "prospects",
    title: "Prospects",
    subtitle: "Manage sourced prospects",
    icon: Icon.Person,
    component: <SourceProspects />,
  },
  {
    id: "persons",
    title: "Persons Details",
    subtitle: "Search CRM persons natively",
...
export default function RaycruiterMenu() {
  ...
  return (
    <List
      navigationTitle="Raycruiter Hub"
      searchBarPlaceholder="Search Deals, Jobs, or Prospects..."
    >
